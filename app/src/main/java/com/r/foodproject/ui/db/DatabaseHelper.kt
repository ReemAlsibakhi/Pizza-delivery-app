...
class DatabaseHelper(context: Context) :
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        ...
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ...
                    "'A signature flame-grilled beef patty toppe with smoked bacon','10','20.0', '0',' ${R.drawable.burger3}', '1', '0')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Beef Burger with Oozy Heeddar'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','5','15.8', '0', ' ${R.drawable.burger4}', '2', '0')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Beef Burger with Beetroot'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','10','20.0', '1', ' ${R.drawable.burger6}', '3', '0')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Beef Burger with Oozy Heeddar'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','5','15.8', '0', ' ${R.drawable.burger7}', '4', '0')"
        )
        ...
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ...
                    "'A signature flame-grilled beef patty toppe with smoked bacon','10','20.0', '0',' ${R.drawable.img1}', '1', '1')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Pizza with Oozy Heeddar'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','5','15.8', '0', ' ${R.drawable.img2}', '2', '1')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Pizza with Beetroot'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','10','20.0', '0', ' ${R.drawable.img3}', '3', '1')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Pizza with Oozy Heeddar'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','5','15.8', '0', ' ${R.drawable.img4}', '4', '1')"
        )
        ...
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ...
                    "'A signature flame-grilled beef patty toppe with smoked bacon','10','20.0', '0',' ${R.drawable.dessert1}', '1', '2')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Dessert with Oozy Heeddar'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','5','15.8', '0', ' ${R.drawable.dessert3}', '2', '2')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Dessert with Beetroot'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','10','20.0', '0', ' ${R.drawable.dessert4}', '3', '2')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Dessert with Oozy Heeddar'," +
                    "'A signature flame-grilled beef patty toppe with smoked bacon','5','15.8', '0', ' ${R.drawable.dessert5}', '4', '2')"
        )
        p0.execSQL(
            "INSERT INTO " + Product.TABLE_NAME + "(${COL_NAME},${COL_DESC},${COL_AMOUNT}" +
                    ",${COL_PRICE},${COL_ISFAV},${COL_IMG},${COL_RATE},${COL_ID_CATEGORIES}) " + " Values ('Dessert with Beetroot'," +
    ...
    fun getProducts(): ArrayList<Product> {
        ...
        val c =
            db.rawQuery(
                "select * from ${Product.TABLE_NAME} order by ${Product.COL_ID}   DESC",
                null
            )
        c.moveToFirst()
        while (!c.isAfterLast) {
